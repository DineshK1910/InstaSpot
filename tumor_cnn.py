...
target_size = (150, 150)
trdataset_path = "/kaggle/input/brain-tumor-classification-mri/Training"
tsdataset_path = "/kaggle/input/brain-tumor-classification-mri/Testing"
classes = ["glioma_tumor",'meningioma_tumor', "no_tumor",'pituitary_tumor']
def transformm(image_path, target_size):
...
for class_idx, class_name in enumerate(classes):
    ...
    for filename in os.listdir(class_folder):
        ...
        transformm = transformm(image_path, target_size)
        X.append(transformm)
        y.append(class_idx)
for class_idx, class_name in enumerate(classes):
